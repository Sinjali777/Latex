\documentclass[16pt,a4paper]{letter}
\usepackage[a4paper,top=1in,right=1in,bottom=1in]{geometry}
...
\signature{Sugam Sen Sinjali, \\
\mbox{BCT, 2nd year}\\
\mbox{Advanced College of Engineering and Management, Kalanki\\}
}
